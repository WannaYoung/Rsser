...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FeedKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// date specification into <code>Date</code> objects
...
/// The actual engine behind the <code>FeedKit</code> framework. <code>XMLFeedParser</code> handles
/// the parsing of RSS and Atom feeds. It is an <code>XMLParserDelegate</code> of
/// itself.
SWIFT_CLASS("_TtC7FeedKit13XMLFeedParser")
@interface XMLFeedParser : NSObject <NSXMLParserDelegate>
...
@interface XMLFeedParser (SWIFT_EXTENSION(FeedKit))
