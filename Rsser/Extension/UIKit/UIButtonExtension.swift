...
extension UIButton {
    ...
    public func setImageForStates(_ image: UIImage, states: [UIControl.State]) {
        states.forEach { setImage(image, for: $0) }
    }
    
    public func setTitleColorForStates(_ color: UIColor, states: [UIControl.State]) {
        states.forEach { setTitleColor(color, for: $0) }
    }
    
    public func setTitleForStates(_ title: String, states: [UIControl.State]) {
...
extension UIButton {
    ...
    func layoutButton(style: EdgeInsetsStyle, imageTitleSpace: CGFloat) {
